...
function Login() {
    return (
        <>
            <section className="bg-gray-50 dark:bg-gray-900 grid place-items-center lg:h-screen md:h-screen h-full">
                <div className="lg:w-[50%] md:w-[75%] sm:w-[85%] w-[95%] mx-auto my-5 bg-gray-800 border border-gray-700 p-6 rounded-xl">
                    ...
                    <form action="">
                        ...
                        <div>
                            ...
                            <button type="submit" className="w-full text-white bg-blue hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
