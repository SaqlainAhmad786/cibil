                    ...
                    <div className="drawer-side h-fit z-50">
                        ...
                        <ul className="menu py-4 px-2 w-80 z-20 space-y-1 bg-gray-800 h-[100dvh] lg:h-[100dvh] min-h-[90dvh] text-gray-100">
                            ...
                            <li className="hover:translate-x-2 duration-200 ">
                                <NavLink to={"/overview/home"} onClick={handleSideBar} className="text-md">
                            ...
                            <li className="hover:translate-x-2 duration-200 ">
                                <NavLink to={"/overview/searchDefaulter"} onClick={handleSideBar} className="text-md">
                                    <Binoculars className="w-5 h-5" />
                                    Money Blocker Finder
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200 ">
                                <NavLink to={"/overview/addDefaulter"} onClick={handleSideBar} className="text-md">
                                    <CirclePlus className="w-5 h-5" />
                                    Add Defaulter
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200 ">
                                <NavLink to={"/overview/defaultersList"} onClick={handleSideBar} className="text-md">
                                    <Users className="w-5 h-5" />
                                    My Defaulters List
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200">
                                <NavLink to={"/subscribe"} onClick={handleSideBar} className="text-md">
                                    <IndianRupee className="w-5 h-5" />
                                    Subscribe
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200">
                                <NavLink to={"/overview/profile"} onClick={handleSideBar} className="text-md">
                                    <User className="w-5 h-5" />
                                    Profile
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200">
                                <NavLink to={"/overview/help"} onClick={handleSideBar} className="text-md">
                                    <CircleHelp className="w-5 h-5" />
                                    Help
                                </NavLink>
                            </li>
                            <li className="hover:translate-x-2 duration-200">
                                <button onClick={handleLogout} className="text-md font-semibold">
