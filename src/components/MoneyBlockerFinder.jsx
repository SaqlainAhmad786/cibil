	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await axios.post(
				"https://vyapar-score-backend-final.onrender.com/api/v1/defaulter/search",
				searchValues,
				{
					headers: {
		...
		<>
			<main>
				<div className="customContainer bg-white p-3 lg:p-5 md:p-4 rounded-lg mx-auto shadow-sm">
					<h1 className="text-lg font-semibold col-span-2 border-neutral-200 pb-2">
						Search for Money Blockers (Defaulters)
					</h1>
					<form
								...
								>
									...
									<div className="flex flex-col gap-2 py-3 mb-2 border-b">
										<div className="flex items-center gap-2">
											...
											<p className="font-medium text-sm text-gray-700 uppercase">
												{item.gst_no}
											</p>
										</div>
										<div className="flex items-center gap-2">
										...
										<div className="flex items-center gap-2">
											<p className="text-sm text-blueClr font-semibold border rounded-full px-[9px] py-[6px]">
												-₹
											</p>
											<p className="font-medium text-sm text-gray-700">
												₹{" "}
