            ...
            <section className="my-4">
                <div className="customContainer bg-white p-5 rounded-lg mx-auto shadow-sm">
                    <div className="mb-5 text-left">
                        <span className="font-bold tracking-wider uppercase text-blue">Pricing</span>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 px-4 -mx-4">
                        <div className="flex mb-8 lg:mb-0">
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-100 border border-gray-300">
                                ...
                                <button type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-blue text-white">SUBSCRIBE</button>
                            </div>
                        </div>
                        <div className="flex mb-8 lg:mb-0">
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-blue text-white">
                                <div className="space-y-2">
                                ...
                                <a rel="noopener noreferrer" href="#" className="inline-block w-full px-5 py-3 font-bold tracking-wider text-center rounded bg-white text-blue">SUBSCRIBE</a>
                            </div>
                        </div>
                        <div className="flex mb-8 lg:mb-0">
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-100 border border-gray-300">
                                ...
                                <a rel="noopener noreferrer" href="#" className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded bg-blue text-white">SUBSCRIBE</a>
                            </div>
                        </div>
                    </div>
                </div>
