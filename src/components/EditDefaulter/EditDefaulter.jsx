                        ...
                        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-x-4 mt-5" >
                            <div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input type="text" className="border rounded-lg px-3 py-2 mb-4 text-black text-sm w-full outline-none border-gray-300 bg-gray-100" placeholder="" name="address" onChange={(e) => handleInputChange(e)} value={formData.address} />
                                </div>
                                <div className="flex flex-col gap-2">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input type="text" className="border rounded-lg px-3 py-2 mb-4 text-gray-500 text-sm w-full outline-none border-gray-300 bg-gray-100 input-disabled uppercase" placeholder="" name="gst_no" value={defaulterData?.gst_no} disabled />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label className="font-semibold text-xs text-gray-500 ">Pending Amount</label>
                                    <input type="number" className="border rounded-lg px-3 py-2 mb-4 text-black text-sm w-full outline-none border-gray-300 bg-gray-100" placeholder="₹" name="pending_amount" onChange={(e) => handleInputChange(e)} value={formData.pending_amount} />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label className="font-semibold text-xs text-gray-500 ">Remark</label>
                                    <textarea rows={5} className="border rounded-lg px-3 py-2 mb-4 text-black text-sm w-full outline-none border-gray-300 bg-gray-100" placeholder="Message" name="remark" onChange={(e) => handleInputChange(e)} value={formData.remark} />
                                </div>
                            </div>
                        </div>
                        <div>
                            <button type="submit" className="w-full flex justify-center items-center text-white bg-blueClr hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center hover:bg-primary-700 focus:ring-primary-800" disabled={loading} onClick={handleSubmit}>
                                {loading
