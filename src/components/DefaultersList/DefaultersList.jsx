                                    ...
                                    <div key={index} className="border rounded-lg shadow-md lg:p-4 p-3 flex lg:flex-row md:flex-col flex-col lg:justify-between justify-start lg:*:items-center">
                                        ...
                                        <div className='lg:col-span-1 md:col-span-2 mt-2'>
                                            <div className="grid grid-cols-2 gap-2">
                                                <Link to={`/overview/editDefaulter/${item._id}`} className="btn btn-outline w-full"><Pencil className="h-4 w-4" />EDIT</Link>
                                                <button className="btn btn-outline btn-success w-full" onClick={() => document.getElementById('my_modal_1').showModal()}>CLEARED!</button>
                                                    ...
                                                    <div className="modal-box p-4 roun">
                                                        ...
                                                        <div className="modal-action">
                                                            <form method="dialog">
                                                                ...
                                                                <button className="btn" onClick={() => handleClear(item._id)}>Confirm</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </dialog>
